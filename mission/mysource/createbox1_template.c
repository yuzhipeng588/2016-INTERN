...
/*=============================================================================
   ...
   file is saved.
        ...
        Filename:  createbox1_template.c
...
{
 {UF_STYLER_DIALOG_INDEX, UF_STYLER_CONSTRUCTOR_CB  , 0, MY_constructor_cb},
 {UF_STYLER_DIALOG_INDEX, UF_STYLER_DESTRUCTOR_CB   , 0, MY_destruct_cb},
 {UF_STYLER_DIALOG_INDEX, UF_STYLER_OK_CB           , 1, MY_ok_cb},
 {UF_STYLER_DIALOG_INDEX, UF_STYLER_APPLY_CB        , 0, MY_apply_cb},
 {UF_STYLER_DIALOG_INDEX, UF_STYLER_CANCEL_CB       , 0, MY_cancel_cb},
 {MY_IMPORT             , UF_STYLER_ACTIVATE_CB     , 0, MY_import_cb},
...
static UF_MB_styler_actions_t actions[] = {
    { "createbox1.dlg",  NULL,   MY_cbs,  UF_MB_STYLER_IS_NOT_TOP },
...
1)  Add the following lines to your MenuScript file in order to 
    ...
    The button, CREATEBOX1_BTN is set up to launch your dialog and 
...
!   ----------------------------------------------------------------
    ...
    MENU UISTYLER_DLG_CASCADE_BTN
      BUTTON CREATEBOX1_BTN
      LABEL Display createbox1 dialog
      ACTIONS createbox1.dlg
    END_OF_MENU
!   ---------------------------------------------------------------
...
4) You should also add the funcitonal prototype to your header file 
   (createbox1.h) and ensure that the file is properly included.
...
extern int <enter the name of your function> ( int *response )
{
    ...
    if ( ( error_code = UF_STYLER_create_dialog ( "createbox1.dlg",
...
/* -------------------------------------------------------------------------
 * Callback Name: MY_constructor_cb
