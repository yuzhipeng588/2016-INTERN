...
/*=============================================================================
   ...
   file is saved.
        ...
        Filename:  createbox2_template.c
...
static UF_MB_styler_actions_t actions[] = {
    { "createbox2.dlg",  NULL,   MY_cbs,  UF_MB_STYLER_IS_NOT_TOP },
...
1)  Add the following lines to your MenuScript file in order to 
    ...
    The button, CREATEBOX2_BTN is set up to launch your dialog and 
...
!   ----------------------------------------------------------------
    ...
    MENU UISTYLER_DLG_CASCADE_BTN
      BUTTON CREATEBOX2_BTN
      LABEL Display createbox2 dialog
      ACTIONS createbox2.dlg
    END_OF_MENU
!   ---------------------------------------------------------------
...
4) You should also add the funcitonal prototype to your header file 
   (createbox2.h) and ensure that the file is properly included.
...
extern int <enter the name of your function> ( int *response )
{
    ...
    if ( ( error_code = UF_STYLER_create_dialog ( "createbox2.dlg",
...
static void create_block2( int dialog_id	)
{
	double length = 0.0;
	double width = 0.0;
	double height = 0.0;
	...
	char *edge_len[6] = {NULL};
	tag_t block_tag = NULL_TAG;
	int error = 0;

	//取得用户输入的长、宽、高。
	get_real_data( dialog_id, MY_REAL_0, &length );
	get_real_data( dialog_id, MY_REAL_1, &width );
	get_real_data( dialog_id, MY_REAL_2, &height );
