...
static UF_MB_styler_actions_t actions[] = {
    { "savepara.dlg",  NULL,   CHANGE_cbs,  UF_MB_STYLER_IS_NOT_TOP },
...
1)  Add the following lines to your MenuScript file in order to 
    ...
    The button, SAVEPARA_BTN is set up to launch your dialog and 
...
!   ----------------------------------------------------------------
    ...
    MENU UISTYLER_DLG_CASCADE_BTN
      BUTTON SAVEPARA_BTN
      LABEL Display savepara dialog
      ACTIONS savepara.dlg
    END_OF_MENU
!   ---------------------------------------------------------------
...
4) You should also add the funcitonal prototype to your header file 
   (savepara.h) and ensure that the file is properly included.
...
extern int <enter the name of your function> ( int *response )
{
    ...
    if ( ( error_code = UF_STYLER_create_dialog ( "savepara.dlg",
...
static void do_ugopen_api(void)
{
	...
	char name[UF_OBJ_NAME_LEN+1]="PART_FAMILY_SHEET";
	...
	UF_XS_extract_spreadsheet(name,spreadname1);
...
//	char name[UF_OBJ_NAME_LEN+1]={NULL};
//		char spreadname[UF_OBJ_NAME_LEN+5];
//		char spreadname1[UF_OBJ_NAME_LEN+5];
//	part_tag = UF_ASSEM_ask_work_part();
//
//	result = UF_OBJ_cycle_objs_in_part(part_tag,UF_spreadsheet_type , &object);//UF_feature_type
//
//	while( object == NULL_TAG )
//	{
//		uc1601("null_tag",1);break;
//	}
