...
#ifndef CREATEBOX4_H_INCLUDED
#define CREATEBOX4_H_INCLUDED
...
#define BLOCK_SEP_3                    ("SEP_3")
#define BLOCK_X                        ("X")
#define BLOCK_Y                        ("Y")
#define BLOCK_Z                        ("Z")
#define BLOCK_DIALOG_OBJECT_COUNT      ( 7 )
