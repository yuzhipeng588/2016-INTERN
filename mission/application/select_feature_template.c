...
/*=============================================================================
   ...
   file is saved.
        ...
        Filename:  select_feature_template.c
...
/*==============================================================================
   ...
   2.  The callback structure: --- SELECT_cbs ---               
...
#include <uf_styler.h>
#include <uf_mb.h> 
#include "select_feature.h"

/* The following definition defines the number of callback entries */
/* in the callback structure:                                      */
/* UF_STYLER_callback_info_t SELECT_cbs */
#define SELECT_CB_COUNT ( 4 + 1 ) /* Add 1 for the terminator */
...
UF_STYLER_create_dialog along with SELECT_CB_COUNT.                       
--------------------------------------------------------------------------*/
static UF_STYLER_callback_info_t SELECT_cbs[SELECT_CB_COUNT] = 
{
 {UF_STYLER_DIALOG_INDEX, UF_STYLER_CONSTRUCTOR_CB  , 0, SELECT_construct_cb},
 {UF_STYLER_DIALOG_INDEX, UF_STYLER_OK_CB           , 1, SELECT_ok_cb},
 {UF_STYLER_DIALOG_INDEX, UF_STYLER_APPLY_CB        , 0, SELECT_apply_cb},
 {UF_STYLER_DIALOG_INDEX, UF_STYLER_CANCEL_CB       , 0, SELECT_cancel_cb},
...
static UF_MB_styler_actions_t actions[] = {
    { "select_feature.dlg",  NULL,   SELECT_cbs,  UF_MB_STYLER_IS_NOT_TOP },
...
1)  Add the following lines to your MenuScript file in order to 
    ...
    The button, SELECT_FEATURE_BTN is set up to launch your dialog and 
...
!   ----------------------------------------------------------------
    ...
    MENU UISTYLER_DLG_CASCADE_BTN
      BUTTON SELECT_FEATURE_BTN
      LABEL Display select_feature dialog
      ACTIONS select_feature.dlg
    END_OF_MENU
!   ---------------------------------------------------------------
...
4) You should also add the funcitonal prototype to your header file 
   (select_feature.h) and ensure that the file is properly included.
...
extern int <enter the name of your function> ( int *response )
{
    ...
    if ( ( error_code = UF_STYLER_create_dialog ( "select_feature.dlg",
           SELECT_cbs,      /* Callbacks from dialog */
           SELECT_CB_COUNT, /* number of callbacks*/
...
--------------------------------------------------------------*/
static void select_box(void)
{
	char message[]="ÇëÑ¡ÔñÒ»¸öbox";
...
/* -------------------------------------------------------------------------
 * Callback Name: SELECT_construct_cb
...
/* -------------------------------------------------------------------------
 * Callback Name: SELECT_cancel_cb
 * This is a callback function associated with an action taken from a
 * UIStyler object. 
 *
 * Input: dialog_id   -   The dialog id indicate which dialog this callback
