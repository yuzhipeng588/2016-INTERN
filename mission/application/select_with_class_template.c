...
/*=============================================================================
   ...
   file is saved.
        ...
        Filename:  select_with_class_template.c
...
{
 {UF_STYLER_DIALOG_INDEX, UF_STYLER_APPLY_CB        , 1, CHANGE_apply_cb},
...
static UF_MB_styler_actions_t actions[] = {
    { "select_with_class.dlg",  NULL,   CHANGE_cbs,  UF_MB_STYLER_IS_NOT_TOP },
...
1)  Add the following lines to your MenuScript file in order to 
    ...
    The button, SELECT_WITH_CLASS_BTN is set up to launch your dialog and 
...
!   ----------------------------------------------------------------
    ...
    MENU UISTYLER_DLG_CASCADE_BTN
      BUTTON SELECT_WITH_CLASS_BTN
      LABEL Display select_with_class dialog
      ACTIONS select_with_class.dlg
    END_OF_MENU
!   ---------------------------------------------------------------
...
4) You should also add the funcitonal prototype to your header file 
   (select_with_class.h) and ensure that the file is properly included.
...
extern int <enter the name of your function> ( int *response )
{
    ...
    if ( ( error_code = UF_STYLER_create_dialog ( "select_with_class.dlg",
